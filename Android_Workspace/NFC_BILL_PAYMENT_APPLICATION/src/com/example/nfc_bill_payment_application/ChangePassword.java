	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		change.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v)
			{
				...
				// name
				String sid = user1.get(SessionManager.KEY_NAME);
				
				System.out.println("sid change password"+sid);
				 ...
				 if(!new_pass.equals(confirmpa))
				{
				 ...
				 else
				 {
					...
					try {
						...
						response = CustomHttpClient.executeHttpPost(Global.URL+"ChangepassSales", nameValuePairs);
