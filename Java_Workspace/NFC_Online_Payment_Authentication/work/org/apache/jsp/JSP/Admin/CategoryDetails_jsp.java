...
resultset=statement.executeQuery(query);
      ...
      out.print(request.getContextPath());
      out.write("/JSP/Admin/AddCategory.jsp\" method=\"post\">\r\n");
      out.write("<center><h2>CategoryDetails</h2></center>\r\n");
      ...
      out.write("<p align=\"center\"><font size=\"4\">&nbsp;<b>cat_name</b></font></p>\r\n");
      out.write("</td>\r\n");
...
while(resultset.next())
{
	...
	cat_name=resultset.getString(2);
      ...
      out.write("<a href=\"");
      out.print(request.getContextPath());
      out.write("/JSP/Admin/DeleteCategory.jsp?cat_code=");
      out.print(cat_code);
      ...
      out.write("<a href=\"");
      out.print(request.getContextPath());
      out.write("/JSP/Admin/UpdateCategory.jsp?cat_code=");
      out.print(cat_code);
