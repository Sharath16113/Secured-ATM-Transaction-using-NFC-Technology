...
public final class AddSubCategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("{\r\n");
      out.write("    document.subcategoryform.subccode.focus();\r\n");
      out.write("\tdocument.getElementById(\"subccode\").focus();\r\n");
      out.write("\tdocument.getElementById(\"subccode\").values=\"\";\r\n");
      out.write("}\r\n");
      out.write("function checkFormValidator()\r\n");
      out.write("{\r\n");
      out.write("\tif(document.subcategoryform.subccode.value==\"\" && document.subcategoryform.subcname.value==\"\" && document.subcategoryform.ccode.value==\"\")\r\n");
      out.write("\t{\r\n");
      out.write("\t\talert(\"Please Enter All Fields\");\r\n");
      out.write("\t\tdocument.subcategoryform.subccode.focus();\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}\r\n");
      out.write("\telse if(document.subcategoryform.subccode.value==\"\")\r\n");
      out.write("\t{\r\n");
      out.write("\t\talert(\"Please Enter subcategorycode\");\r\n");
      out.write("\t\tdocument.subcategoryform.subccode.focus();\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}\r\n");
      out.write("\telse if(document.subcategoryform.subcname.value==\"\")\r\n");
      out.write("\t{\r\n");
      out.write("\t\talert(\"Please Enter subcategoryname\");\r\n");
      out.write("\t\tdocument.subcategoryform.subcname.focus();\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}\r\n");
      out.write("\telse if(document.subcategoryform.ccode.value==\"\")\r\n");
      out.write("\t{\r\n");
      out.write("\t\talert(\"Please Enter categorycode\");\r\n");
      out.write("\t\tdocument.subcategoryform.ccode.focus();\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      ...
      out.write("/bg1.jpg\">\r\n");
      out.write("<h1><center>SalesDetails</center></h1>\r\n");
      out.write("<center>\r\n");
      out.write("<form action=\"");
      out.print(request.getContextPath());
      out.write("/AddSubCategoryServlet\" method=\"post\" name=\"subcategoryform\" onsubmit=\"return checkFormValidator()\">\r\n");
      out.write("<table width=\"25\">\r\n");
      out.write("<tr><td><b>SubCatCode:&nbsp;&nbsp;</b></td><td><input type=\"text\" required name=\"subccode\"></input></td></tr><br></br>\r\n");
      out.write("<tr><td><b>SubCatName:&nbsp;&nbsp;</b></td><td><input type=\"text\" required name=\"subcname\"></input></td></tr><br></br>\r\n");
      out.write("<tr><td><b>CatCode:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td><td><input type=\"text\" required name=\"ccode\"></input></td></tr><br></br></table>\r\n");
