...
{ 
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("/Loginban\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t<h3 style=\"height: 30px;\">Bank Login</h3>\r\n");
      out.write("\t\t\t\t\t\t<div style=\"height: 60px\">\r\n");
      out.write("\t\t\t\t\t\t\t<label >Sales Person ID:</label>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"salesid\" id=\"userid\" placeholder=\"bank ID\" required=\"yes\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div style=\"height: 60px\">\r\n");
