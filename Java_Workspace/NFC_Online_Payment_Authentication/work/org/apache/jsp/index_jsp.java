...
{ 
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<h3 style=\"height: 30px;\">Admin Login</h3>\r\n");
      out.write("\t\t\t\t\t\t<div style=\"height: 60px\">\r\n");
      out.write("\t\t\t\t\t\t\t<label >Admin ID:</label>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"adminid\" id=\"userid\" placeholder=\"Admin ID\" required=\"yes\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div style=\"height: 60px\">\r\n");
      out.write("\t\t\t\t\t\t\t<label >Password: </label>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"password\" name=\"adminpass\" id=\"password\" placeholder=\"Password\" required=\"yes\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<!-- <div style=\"height:20px;padding-top:20px;padding-right: 10px\">\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</div> -->\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<a href=\"salesperson.jsp\" rel=\"login\" class=\"linkform\">Sales Person</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"bank.jsp\" rel=\"login\" class=\"linkform\">Bank Login</a>\r\n");
