	  ...
	  <header>
        ...
        <nav>
          <ul class="lavaLampWithImage" id="lava_menu">
            ...
            <li><a href="<%=request.getContextPath()%>/JSP/salesperson/CatTest.jsp" target="myframe">Sales</a></li>
          
           <li><a href="<%=request.getContextPath()%>/JSP/salesperson/changepwd2.jsp" " target="myframe">ChangePassword</a></li>
