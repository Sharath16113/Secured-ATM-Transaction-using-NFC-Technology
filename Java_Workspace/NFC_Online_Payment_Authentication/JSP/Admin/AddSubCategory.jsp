...
{
	if(document.subcategoryform.subccode.value=="" && document.subcategoryform.subcname.value=="" && document.subcategoryform.ccode.value=="")
	{
		alert("Please Enter All Fields");
		document.subcategoryform.subccode.focus();
		return false;
	}
	else if(document.subcategoryform.subccode.value=="")
	{
		alert("Please Enter subcategorycode");
		document.subcategoryform.subccode.focus();
		return false;
	}
...
<center>
<form action="<%=request.getContextPath()%>/AddSubCategoryServlet" method="post" name="subcategoryform" onsubmit="return checkFormValidator()">
<table width="25">
<tr><td><b>SubCatCode:&nbsp;&nbsp;</b></td><td><input type="text" required name="subccode"></input></td></tr><br></br>
<tr><td><b>SubCatName:&nbsp;&nbsp;</b></td><td><input type="text" required name="subcname"></input></td></tr><br></br>
<tr><td><b>CatCode:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td><td><input type="text" required name="ccode"></input></td></tr><br></br></table>
