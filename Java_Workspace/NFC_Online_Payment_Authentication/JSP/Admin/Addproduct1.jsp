...
function checkFormValidator()
{
	...
	if(document.productform.pname.value=="")
	{
		alert("Please Enter correct productname");
		document.productform.pname.focus();
		return false;
	}
	...
	else if(document.productform.pphoto.value=="")
	{
		alert("Please Enter productphoto");
		document.productform.pphoto.focus();
		return false;
	}
	...
	if(document.productform.pmrp.value=="")
	{
		alert("Please Enter correct productmrp");
		document.productform.pmrp.focus();
		return false;
	}
	...
	{
		alert("Please Enter correct productprice");
		document.productform.price.focus();
		return false;
	}
...
function CheckName()
{
	var name=document.productform.pname.value;
	var len=name.length;
	for(var i=0;i<len;i++)
	{
		...
		if((a>"65") || (a<"122"))
		{
			...
			document.productform.pname.value="";
			document.productform.pname.focus();
			return false;
		}
	}
...
String pdesc1=request.getParameter("pdesc");
String ccode1=request.getParameter("ccode");
String subccode1=request.getParameter("subccode");
String pprice1=request.getParameter("pprice");
String pmrp1=request.getParameter("pmrp");
String price1=request.getParameter("price");
String ptax1=request.getParameter("ptax");
%>
<%
session.setAttribute("pcode",pcode1);
session.setAttribute("pname",pname1.toString());
session.setAttribute("pdesc",pdesc1.toString());
session.setAttribute("ccode",ccode1.toString());
session.setAttribute("subccode",subccode1.toString());
session.setAttribute("pprice",pprice1.toString());
session.setAttribute("pmrp",pmrp1.toString());
session.setAttribute("price",price1.toString());
session.setAttribute("ptax",ptax1.toString());
System.out.println("addpro");
%>
<center>
<form action="<%=request.getContextPath()%>/AttachFile" name="productform" method="post" onsubmit="return checkFormValidator()" enctype="multipart/form-data">
<table border="0" width="25">
<tr><td><b>ProPhoto:&nbsp; </b></td><td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="file" name="file"></input></td></tr>
</table><br></br>
