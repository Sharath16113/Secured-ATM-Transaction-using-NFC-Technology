...
String query="select * from d_cat";
resultset=statement.executeQuery(query);
%>
<form action="<%=request.getContextPath()%>/JSP/Admin/AddCategory.jsp" method="post">
<center><h2>CategoryDetails</h2></center>
...
<td width="35%">
<p align="center"><font size="4">&nbsp;<b>cat_name</b></font></p>
</td>
<td width="26%">
...
{
	++count;
	cat_code=resultset.getInt(1);
	cat_name=resultset.getString(2);
%>
<tr>
<td width="35%"><%=cat_code%></td>
<td width="27%"><%=cat_name%></td>
<td width="26%">
<a href="<%=request.getContextPath()%>/JSP/Admin/DeleteCategory.jsp?cat_code=<%=cat_code%>" Onclick="return confirm('Do you want to delete : <%=cat_code%>?')">Delete</a>
</td>
<td width="26%">
<a href="<%=request.getContextPath()%>/JSP/Admin/UpdateCategory.jsp?cat_code=<%=cat_code%>" Onclick="return confirm('Do you want to update : <%=cat_code%>?')">Edit</a>
</td>
</tr>
<%
}
